          ...
          <div className="flex flex-col text-center gap-4 mx-auto justify-center items-center lg:flex-row">
              <div className="flex bg-[#282928] p-4 rounded-full justify-center items-center shadow min-w-full gap-4 sm:min-w-72">
                  <figure className="flex-initial w-12 mr-auto sm:mx-auto">
                      <img src="/public/assets/other-assets/svg/social/discord-logo.svg" alt="" className="mr-auto sm:mx-auto w-10 h-10"/>
                  </figure>
              ...
              <div className="flex bg-[#282928] p-4 rounded-full justify-center items-center shadow min-w-full gap-4 sm:min-w-72">
                  <figure className="flex-initial w-12 mr-auto sm:mx-auto">
                      <img src="/public/assets/other-assets/svg/social/whatsapp-logo.svg" alt="" className="mr-auto sm:mx-auto w-10 h-10"/>
                  </figure>
                  <p className="font-bold md:mx-auto">
                      Grupo de WhatsApp
                  </p>
              ...
              <div className="flex bg-[#282928] p-4 rounded-full justify-center items-center shadow min-w-full gap-4 sm:min-w-72">
                  <figure className="flex-initial w-12 mr-auto sm:mx-auto">
                      <img src="/public/assets/other-assets/svg/social/github-logo.svg" alt="" className="mr-auto sm:mx-auto w-10 h-10"/>
                  </figure>
                  <p className="font-bold md:mx-auto">
                      Comunidad de GitHub
                  </p>
